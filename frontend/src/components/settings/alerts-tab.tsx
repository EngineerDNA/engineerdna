    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
            Configure alert rules and thresholds for monitoring
          </p>
        </div>
        <button
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
          Configure where alerts are sent (email, browser notifications, etc.)
        </p>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
          Send a test alert to verify your notification channels are working
        </p>
        <button className="px-4 py-2 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors">
          Send Test Alert
        </button>
      </div>
