...
import { IgnoredIdentitiesList } from '../components/IgnoredIdentitiesList';
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
          <div className="p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded">
            <p className="text-red-600 dark:text-red-400">
              {error && `Failed to load system info: ${error.message}`}
              {settingsError && `Failed to load settings: ${settingsError.message}`}
            </p>
          </div>
        </div>
      </div>
    ...
    <div>
      <div className="mb-6">
        ...
        <p className="text-gray-600 dark:text-gray-400 mt-1">
          Configure system preferences and view information
        </p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
          <h3 className="text-lg font-semibold mb-4 text-gray-900 dark:text-gray-100">Plugins</h3>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
          <h3 className="text-lg font-semibold mb-4 text-gray-900 dark:text-gray-100">Version</h3>
          <div className="space-y-2">
            <div className="flex justify-between">
              <span className="text-gray-600 dark:text-gray-400">EngineerDNA:</span>
